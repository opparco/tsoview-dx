...
namespace TDCG
{
    ...
    public class TSOSubMesh : IDisposable
    {
        ...
        public static InputElement[] ie = new InputElement[]
        {
            new InputElement("POSITION", 0, Format.R32G32B32_Float, 0, 0), // 12
            new InputElement("TEXCOORD", 3, Format.R32G32B32A32_Float, 12, 0), // 16
            new InputElement("TEXCOORD", 4, Format.R8G8B8A8_UInt, 28, 0), // 4
